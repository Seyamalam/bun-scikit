...
- Regression: fit `2.602x`, predict `4.507x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.356x`, predict `3.266x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.527x`, predict `5.745x`
- RandomForest (`js-fast`): fit `2.887x`, predict `4.139x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.775x`, predict `0.462x`; RandomForest `zig/js` fit `1.164x`, predict `1.684x`
