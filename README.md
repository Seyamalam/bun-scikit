...
- Regression: fit `2.222x`, predict `3.383x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.564x`, predict `4.716x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.677x`, predict `7.338x`
- RandomForest (`js-fast`): fit `2.803x`, predict `2.991x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.728x`, predict `0.399x`; RandomForest `zig/js` fit `1.145x`, predict `1.796x`
