...
- Regression: fit `2.553x`, predict `3.223x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.353x`, predict `3.326x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.610x`, predict `6.500x`
- RandomForest (`js-fast`): fit `3.020x`, predict `4.214x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.745x`, predict `0.401x`; RandomForest `zig/js` fit `1.113x`, predict `1.777x`
