...
- Regression: fit `1.867x`, predict `2.146x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.158x`, predict `2.582x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.475x`, predict `4.923x`
- RandomForest (`js-fast`): fit `2.647x`, predict `3.070x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.828x`, predict `0.490x`; RandomForest `zig/js` fit `1.161x`, predict `1.712x`
- Snapshot generated at `2026-04-27T11:03:43.950Z`

### Regression

| Implementation | Model | Fit median (ms) | Predict median (ms) | MSE | R2 |
|---|---|---:|---:|---:|---:|
| bun-scikit | StandardScaler + LinearRegression(normal) | 0.2886 | 0.0315 | 0.117545 | 0.529539 |
| python-scikit-learn | StandardScaler + LinearRegression | 0.5388 | 0.0676 | 0.117545 | 0.529539 |

Bun fit speedup vs scikit-learn: 1.867x
Bun predict speedup vs scikit-learn: 2.146x
...
|---|---|---:|---:|---:|---:|
| bun-scikit | StandardScaler + LogisticRegression(gd,zig) | 1.5135 | 0.0450 | 0.863415 | 0.876106 |
| python-scikit-learn | StandardScaler + LogisticRegression(lbfgs) | 1.7531 | 0.1162 | 0.863415 | 0.875000 |

Bun fit speedup vs scikit-learn: 1.158x
Bun predict speedup vs scikit-learn: 2.582x
...
|---|---|---:|---:|---:|---:|
| DecisionTreeClassifier(maxDepth=8) [js-fast] | bun-scikit | 1.3369 | 0.0263 | 0.936585 | 0.937799 |
| DecisionTreeClassifier | python-scikit-learn | 1.9717 | 0.1296 | 0.931707 | 0.933962 |
| RandomForestClassifier(nEstimators=80,maxDepth=8) [js-fast] | bun-scikit | 40.3918 | 1.7460 | 0.995122 | 0.995261 |
| RandomForestClassifier | python-scikit-learn | 106.9080 | 5.3605 | 0.995122 | 0.995261 |

DecisionTree fit speedup vs scikit-learn: 1.475x
DecisionTree predict speedup vs scikit-learn: 4.923x
DecisionTree accuracy delta (bun - sklearn): 4.878e-3
DecisionTree f1 delta (bun - sklearn): 3.837e-3

RandomForest fit speedup vs scikit-learn: 2.647x
RandomForest predict speedup vs scikit-learn: 3.070x
...
|---|---|---:|---:|---:|---:|
| DecisionTreeClassifier(maxDepth=8) | js-fast | 1.3369 | 0.0263 | 0.936585 | 0.937799 |
| DecisionTreeClassifier(maxDepth=8) | zig-tree | 1.6155 | 0.0537 | 0.936585 | 0.937799 |
| DecisionTreeClassifier | python-scikit-learn | 1.9717 | 0.1296 | 0.931707 | 0.933962 |
| RandomForestClassifier(nEstimators=80,maxDepth=8) | js-fast | 40.3918 | 1.7460 | 0.995122 | 0.995261 |
| RandomForestClassifier(nEstimators=80,maxDepth=8) | zig-tree | 34.8039 | 1.0200 | 1.000000 | 1.000000 |
| RandomForestClassifier | python-scikit-learn | 106.9080 | 5.3605 | 0.995122 | 0.995261 |

DecisionTree zig/js fit speedup: 0.828x
DecisionTree zig/js predict speedup: 0.490x
RandomForest zig/js fit speedup: 1.161x
