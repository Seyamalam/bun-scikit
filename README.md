...
- Regression: fit `2.057x`, predict `2.733x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.323x`, predict `3.118x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.403x`, predict `4.370x`
- RandomForest (`js-fast`): fit `2.977x`, predict `4.090x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.860x`, predict `0.557x`; RandomForest `zig/js` fit `1.135x`, predict `1.731x`
