...
- Regression: fit `2.162x`, predict `3.418x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.165x`, predict `2.612x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.626x`, predict `5.488x`
- RandomForest (`js-fast`): fit `2.643x`, predict `2.914x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.741x`, predict `0.459x`; RandomForest `zig/js` fit `1.156x`, predict `1.812x`
