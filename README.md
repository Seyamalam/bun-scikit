...
- Regression: fit `1.857x`, predict `2.421x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.342x`, predict `2.966x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.128x`, predict `4.017x`
- RandomForest (`js-fast`): fit `2.899x`, predict `3.973x`
- Tree backend matrix: DecisionTree `zig/js` fit `1.078x`, predict `0.654x`; RandomForest `zig/js` fit `1.162x`, predict `1.792x`
