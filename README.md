...
- Regression: fit `2.888x`, predict `6.954x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.866x`, predict `4.905x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.561x`, predict `7.306x`
- RandomForest (`js-fast`): fit `3.183x`, predict `4.077x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.821x`, predict `0.504x`; RandomForest `zig/js` fit `1.138x`, predict `1.868x`
