...
- Regression: fit `2.721x`, predict `4.551x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.338x`, predict `3.212x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.635x`, predict `5.436x`
- RandomForest (`js-fast`): fit `2.971x`, predict `4.293x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.748x`, predict `0.461x`; RandomForest `zig/js` fit `1.125x`, predict `1.726x`
