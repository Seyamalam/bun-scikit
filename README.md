...
- Regression: fit `2.012x`, predict `2.648x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.294x`, predict `2.823x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.453x`, predict `5.504x`
- RandomForest (`js-fast`): fit `2.856x`, predict `4.163x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.835x`, predict `0.533x`; RandomForest `zig/js` fit `1.175x`, predict `1.766x`
