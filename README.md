...
- Regression: fit `2.592x`, predict `4.966x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.315x`, predict `2.609x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.536x`, predict `5.413x`
- RandomForest (`js-fast`): fit `2.902x`, predict `4.353x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.771x`, predict `0.536x`; RandomForest `zig/js` fit `1.148x`, predict `1.712x`
