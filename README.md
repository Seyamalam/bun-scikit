...
- Regression: fit `1.336x`, predict `1.936x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.189x`, predict `2.661x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.577x`, predict `5.548x`
- RandomForest (`js-fast`): fit `2.686x`, predict `2.993x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.771x`, predict `0.450x`; RandomForest `zig/js` fit `1.152x`, predict `1.771x`
