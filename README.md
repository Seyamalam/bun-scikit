...
- Regression: fit `2.658x`, predict `3.091x` (MSE delta `6.363e-14`, R2 delta `-2.540e-13`)
- Classification: fit `1.335x`, predict `3.196x` (accuracy delta `0.000e+0`, F1 delta `1.106e-3`)
- DecisionTree (`js-fast`): fit `1.605x`, predict `5.770x`
- RandomForest (`js-fast`): fit `2.967x`, predict `3.986x`
- Tree backend matrix: DecisionTree `zig/js` fit `0.763x`, predict `0.444x`; RandomForest `zig/js` fit `1.113x`, predict `1.819x`
