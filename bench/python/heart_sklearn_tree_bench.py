...
def benchmark_model(model_factory, x_train, y_train, x_test, y_test, iterations, warmup):
    fit_times = []
    predict_times = []
    predictions_for_metrics = None

    total_loops = iterations + warmup
...
def main():
    ...
    decision_tree_metrics = benchmark_model(
    ...
    random_forest_metrics = benchmark_model(
